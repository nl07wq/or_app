...
void main() {
  ...
  testWidgets('bakes the accepted tuner feedback into canonical SVG paths', (
    ...
    _expectBounds(back.paths, 'back-trapezius', 78.5, 54.98, 121.5, 109.75);
    _expectBounds(back.paths, 'back-lats-left', 73.46, 99.5, 98.5, 152.5);
    _expectBounds(back.paths, 'back-lats-right', 101.5, 99.5, 126.54, 152.5);
