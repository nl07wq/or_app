...
void main() {
  ...
  test(
    'Current schema restores mixed Confirmation v1 and reopened v2',
    () async {
      ...
      final digest = PersistedDailyLogConfirmationRecord.digestSnapshot(
        snapshot,
      );
      ...
      expect(decoded.data.keys, hasLength(BackupSections.all.length));
