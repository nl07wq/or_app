...
String dailyAssessmentSpecificLabel(DailyAssessmentItem item) {
  final labels = switch (item.metric) {
    ...
    DailyAssessmentMetric.calorieBalance => const {
      'TARGET DEFICIT': '本日のカロリー収支は目標の赤字範囲です。',
      'NEAR BALANCE': '本日のカロリー収支はほぼ均衡しています。',
      'LARGE DEFICIT': '本日のカロリー赤字がやや大きくなっています。',
      'VERY LARGE DEFICIT': '本日のカロリー赤字が非常に大きくなっています。',
      'EXTREME DEFICIT': '本日のカロリー赤字が過大です。',
      'SURPLUS WATCH': '本日のカロリー収支は黒字になっています。',
      'HIGH SURPLUS': '本日のカロリー黒字が大きくなっています。',
    },
    ...
    DailyAssessmentMetric.steps => const {
      'LOW LOAD': '本日の歩行負荷は低い状態です。',
      'MODERATE LOAD': '本日の歩行負荷は中程度です。',
      'HIGH LOAD': '本日の歩行負荷は高い状態です。',
      'VERY HIGH LOAD': '本日の歩行負荷が非常に高い状態です。',
    },
...
String dailyAssessmentConstraintLabel(String canonical) =>
    const <String, String>{
      ...
      'CALORIE SURPLUS': '本日のカロリー収支が黒字です。',
      'CALORIE DEFICIT': '本日のカロリー赤字が大きい状態です。',
      'LOW PROTEIN': 'たんぱく質が不足しています。',
      'LOW HYDRATION': '水分摂取量が不足しています。',
      'RECENT STEP LOAD': '本日の歩行負荷が高い状態です。',
