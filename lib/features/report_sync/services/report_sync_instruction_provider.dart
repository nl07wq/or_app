...
When the formal workType is holiday, describe WORK as 公休日 and do not expose zero-duration artifacts such as 実働0時間, 勤務0時間, or 0:00 in human-readable analysis text. Preserve the formal zero values unchanged in source JSON.
